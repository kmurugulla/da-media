  ...
  showImagePreview(asset) {
    ...
    header.innerHTML = `
      ...
      <button class="close-btn" 
        onclick="document.body.removeChild(document.querySelector('.image-preview-overlay'))">×</button>
    `;
    ...
    tabs.innerHTML = `
      <button class="device-tab active" data-device="desktop" 
        title="Show desktop responsive variant">🖥 Desktop</button>
      <button class="device-tab" data-device="tablet" 
        title="Show tablet responsive variant"><span class="tablet-icon"></span> Tablet</button>
  ...
  createPreviewImage(asset) {
    ...
    img.onerror = () => {
      img.src = 'data:image/svg+xml;base64,'
        + 'PHN2ZyB3aWR0aD0iNDAwIiBoZWlnaHQ9IjMwMCIgeG1sbnM9Imh0dHA6Ly93d3cudzMub3JnLzIwMDAvc3ZnIj4'
        + '<cmVjdCB3aWR0aD0iMTAwJSIgaGVpZ2h0PSIxMDAlIiBmaWxsPSIjZjVmNWY1Ii8+PHRleHQgeD0iNTAlIiB5PSI1MCUiI'
        + 'GZvbnQtZmFtaWx5PSJBcmlhbCIgZm9udC1zaXplPSIxNiIgZmlsbD0iIzk5OSIgdGV4dC1hbmNob3I9Im1pZGRsZSIgZHk9I'
        + 'i4zZW0iPkltYWdlIG5vdCBhdmFpbGFibGU8L3RleHQ+PC9zdmc+';
